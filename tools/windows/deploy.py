...
class Wix:
    ...
    def __init__(
        ...
        if self.versionType not in allowedVersionTypes:
            raise ValueError(
        ...
        if self.upgradePolicy not in allowedUpgradePolicies[self.versionType]:
            raise ValueError(
        ...
        if self.architecture not in allowedArchitectures:
            raise ValueError(
