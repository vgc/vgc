...
#    define VGC_SCENE_API_EXCEPTION
#else
#    if defined(VGC_SCENE_EXPORTS)
#        define VGC_SCENE_API           VGC_CORE_DLL_EXPORT
#        define VGC_SCENE_API_EXCEPTION VGC_CORE_DLL_EXPORT_EXCEPTION
#    else
#        define VGC_SCENE_API           VGC_CORE_DLL_IMPORT
#        define VGC_SCENE_API_EXCEPTION VGC_CORE_DLL_IMPORT_EXCEPTION
#    endif
