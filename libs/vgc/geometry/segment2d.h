...
public:
    ...
    ///
    friend constexpr bool operator==(const Segment2dIntersection& i1, const Segment2dIntersection& i2) {
...
template<>
struct fmt::formatter<vgc::geometry::Segment2dIntersection> {
    ...
    auto format(const vgc::geometry::Segment2dIntersection& i, FormatContext& ctx) {
        switch (i.type()) {
...
void write(OStream& out, const Segment2dIntersection& i) {
