...
Segment2fIntersection segmentIntersect(
    ...
    if (std::abs(delta) > 0) {
        ...
        //
        if (a1 == a2) {
            return Segment2fIntersection(a1, 0, 0);
        }
        else if (b1 == b2) {
            return Segment2fIntersection(b1, 1, 1);
        }
        else if (a1 == b2) {
            return Segment2fIntersection(a1, 0, 1);
        }
        else if (b1 == a2) {
            return Segment2fIntersection(b1, 1, 0);
        }
        ...
        if (t1 >= 0. && t1 <= 1. && t2 >= 0. && t2 <= 1.) {
            ...
            return Segment2fIntersection(p, t1, t2);
        }
        else {
        ...
        return Segment2fIntersection(a1, a1, 0, 0, 0, 0);
    }
}
