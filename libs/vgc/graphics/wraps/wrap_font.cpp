...
void wrapSizedFontParams(py::module& m)
{
    ...
    py::class_<This>(m, "SizedFontParams")
        ...
        .def(py::init([](Int pointSize, Int dpi, FontHinting hinting) {
                return This::fromPoints(pointSize, dpi, hinting);
             }), "pointSize"_a, "dpi"_a, "hinting"_a)
        .def(py::init([](Int pointSize, Int hdpi, Int vdpi, FontHinting hinting) {
                return This::fromPoints(pointSize, hdpi, vdpi, hinting);
             }), "pointSize"_a, "hdpi"_a, "vdpi"_a, "hinting"_a)
...
void wrapSizedGlyph(py::module& m)
{
    ...
    py::class_<This, Holder, Parent>(m, "SizedGlyph")
        ...
        .def_property_readonly("fill", py::overload_cast<FloatArray&, const Mat3f&>(
                                   &This::fill, py::const_))
        .def_property_readonly("fill", py::overload_cast<FloatArray&, const Vec2f&>(
                                   &This::fill, py::const_))
