...
#define VGC_PP_TRIM_VAEND(...)                                                  \
  VGC_PP_EXPAND(VGC_PP_TVE_DISPATCH_(__VA_ARGS__,                               \
    VGC_PP_TVE_9_, VGC_PP_TVE_8_, VGC_PP_TVE_7_, VGC_PP_TVE_6_, VGC_PP_TVE_5_,  \
    VGC_PP_TVE_4_, VGC_PP_TVE_3_, VGC_PP_TVE_2_, VGC_PP_TVE_1_, VGC_PP_TVE_0_   \
  )(__VA_ARGS__))
...
#define VGC_PP_TRANSFORM(F, ...)                                                \
  VGC_PP_EXPAND(VGC_PP_TF_DISPATCH_(__VA_ARGS__,                                \
    VGC_PP_TF_9_,VGC_PP_TF_8_,VGC_PP_TF_7_,VGC_PP_TF_6_,VGC_PP_TF_5_,           \
