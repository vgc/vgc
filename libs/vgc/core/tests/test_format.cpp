...
VGC_DEFINE_ENUM_BEGIN(VeryLongEnum)
    VGC_ENUM_VALUE(V1, "v1")
    VGC_ENUM_VALUE(V2, "v2")
    VGC_ENUM_VALUE(V3, "v3")
    VGC_ENUM_VALUE(V4, "v4")
    VGC_ENUM_VALUE(V5, "v5")
    VGC_ENUM_VALUE(V6, "v6")
    VGC_ENUM_VALUE(V7, "v7")
    VGC_ENUM_VALUE(V8, "v8")
    VGC_ENUM_VALUE(V9, "v9")
    VGC_ENUM_VALUE(V10, "v10")
    VGC_ENUM_VALUE(V11, "v11")
    VGC_ENUM_VALUE(V12, "v12")
    VGC_ENUM_VALUE(V13, "v13")
    VGC_ENUM_VALUE(V14, "v14")
    VGC_ENUM_VALUE(V15, "v15")
    VGC_ENUM_VALUE(V16, "v16")
    VGC_ENUM_VALUE(V17, "v17")
    VGC_ENUM_VALUE(V18, "v18")
    VGC_ENUM_VALUE(V19, "v19")
    VGC_ENUM_VALUE(V20, "v20")
    VGC_ENUM_VALUE(V21, "v21")
    VGC_ENUM_VALUE(V22, "v22")
    VGC_ENUM_VALUE(V23, "v23")
    VGC_ENUM_VALUE(V24, "v24")
    VGC_ENUM_VALUE(V25, "v25")
    VGC_ENUM_VALUE(V26, "v26")
    VGC_ENUM_VALUE(V27, "v27")
    VGC_ENUM_VALUE(V28, "v28")
    VGC_ENUM_VALUE(V29, "v29")
    VGC_ENUM_VALUE(V30, "v30")
    VGC_ENUM_VALUE(V31, "v31")
    VGC_ENUM_VALUE(V32, "v32")
    VGC_ENUM_VALUE(V33, "v33")
    VGC_ENUM_VALUE(V34, "v34")
    VGC_ENUM_VALUE(V35, "v35")
    VGC_ENUM_VALUE(V36, "v36")
    VGC_ENUM_VALUE(V37, "v37")
    VGC_ENUM_VALUE(V38, "v38")
    VGC_ENUM_VALUE(V39, "v39")
    VGC_ENUM_VALUE(V40, "v40")
    VGC_ENUM_VALUE(V41, "v41")
    VGC_ENUM_VALUE(V42, "v42")
    VGC_ENUM_VALUE(V43, "v43")
    VGC_ENUM_VALUE(V44, "v44")
    VGC_ENUM_VALUE(V45, "v45")
    VGC_ENUM_VALUE(V46, "v46")
    VGC_ENUM_VALUE(V47, "v47")
    VGC_ENUM_VALUE(V48, "v48")
    VGC_ENUM_VALUE(V49, "v49")
    VGC_ENUM_VALUE(V50, "v50")
    VGC_ENUM_VALUE(V51, "v51")
    VGC_ENUM_VALUE(V52, "v52")
    VGC_ENUM_VALUE(V53, "v53")
    VGC_ENUM_VALUE(V54, "v54")
    VGC_ENUM_VALUE(V55, "v55")
    VGC_ENUM_VALUE(V56, "v56")
    VGC_ENUM_VALUE(V57, "v57")
    VGC_ENUM_VALUE(V58, "v58")
    VGC_ENUM_VALUE(V59, "v59")
    VGC_ENUM_VALUE(V60, "v60")
    VGC_ENUM_VALUE(V61, "v61")
    VGC_ENUM_VALUE(V62, "v62")
    VGC_ENUM_VALUE(V63, "v63")
    VGC_ENUM_VALUE(V64, "v64")
    VGC_ENUM_VALUE(V65, "v65")
    VGC_ENUM_VALUE(V66, "v66")
    VGC_ENUM_VALUE(V67, "v67")
    VGC_ENUM_VALUE(V68, "v68")
    VGC_ENUM_VALUE(V69, "v69")
    VGC_ENUM_VALUE(V70, "v70")
    VGC_ENUM_VALUE(V71, "v71")
    VGC_ENUM_VALUE(V72, "v72")
    VGC_ENUM_VALUE(V73, "v73")
    VGC_ENUM_VALUE(V74, "v74")
    VGC_ENUM_VALUE(V75, "v75")
    VGC_ENUM_VALUE(V76, "v76")
    VGC_ENUM_VALUE(V77, "v77")
    VGC_ENUM_VALUE(V78, "v78")
    VGC_ENUM_VALUE(V79, "v79")
    VGC_ENUM_VALUE(V80, "v80")
    VGC_ENUM_VALUE(V81, "v81")
    VGC_ENUM_VALUE(V82, "v82")
    VGC_ENUM_VALUE(V83, "v83")
    VGC_ENUM_VALUE(V84, "v84")
    VGC_ENUM_VALUE(V85, "v85")
    VGC_ENUM_VALUE(V86, "v86")
    VGC_ENUM_VALUE(V87, "v87")
    VGC_ENUM_VALUE(V88, "v88")
    VGC_ENUM_VALUE(V89, "v89")
    VGC_ENUM_VALUE(V90, "v90")
    VGC_ENUM_VALUE(V91, "v91")
    VGC_ENUM_VALUE(V92, "v92")
    VGC_ENUM_VALUE(V93, "v93")
    VGC_ENUM_VALUE(V94, "v94")
    VGC_ENUM_VALUE(V95, "v95")
    VGC_ENUM_VALUE(V96, "v96")
    VGC_ENUM_VALUE(V97, "v97")
    VGC_ENUM_VALUE(V98, "v98")
    VGC_ENUM_VALUE(V99, "v99")
    VGC_ENUM_VALUE(V100, "v100")
    VGC_ENUM_VALUE(V101, "v101")
    VGC_ENUM_VALUE(V102, "v102")
    VGC_ENUM_VALUE(V103, "v103")
    VGC_ENUM_VALUE(V104, "v104")
    VGC_ENUM_VALUE(V105, "v105")
    VGC_ENUM_VALUE(V106, "v106")
    VGC_ENUM_VALUE(V107, "v107")
    VGC_ENUM_VALUE(V108, "v108")
    VGC_ENUM_VALUE(V109, "v109")
    VGC_ENUM_VALUE(V110, "v110")
    VGC_ENUM_VALUE(V111, "v111")
    VGC_ENUM_VALUE(V112, "v112")
    VGC_ENUM_VALUE(V113, "v113")
    VGC_ENUM_VALUE(V114, "v114")
    VGC_ENUM_VALUE(V115, "v115")
    VGC_ENUM_VALUE(V116, "v116")
    VGC_ENUM_VALUE(V117, "v117")
    VGC_ENUM_VALUE(V118, "v118")
    VGC_ENUM_VALUE(V119, "v119")
    VGC_ENUM_VALUE(V120, "v120")
    VGC_ENUM_VALUE(V121, "v121")
    VGC_ENUM_VALUE(V122, "v122")
    VGC_ENUM_VALUE(V123, "v123")
    VGC_ENUM_VALUE(V124, "v124")
    VGC_ENUM_VALUE(V125, "v125")
    VGC_ENUM_VALUE(V126, "v126")
    VGC_ENUM_VALUE(V127, "v127")
    VGC_ENUM_VALUE(V128, "v128")
    VGC_ENUM_VALUE(V129, "v129")
    VGC_ENUM_VALUE(V130, "v130")
    VGC_ENUM_VALUE(V131, "v131")
    VGC_ENUM_VALUE(V132, "v132")
    VGC_ENUM_VALUE(V133, "v133")
    VGC_ENUM_VALUE(V134, "v134")
    VGC_ENUM_VALUE(V135, "v135")
    VGC_ENUM_VALUE(V136, "v136")
    VGC_ENUM_VALUE(V137, "v137")
    VGC_ENUM_VALUE(V138, "v138")
    VGC_ENUM_VALUE(V139, "v139")
    VGC_ENUM_VALUE(V140, "v140")
    VGC_ENUM_VALUE(V141, "v141")
    VGC_ENUM_VALUE(V142, "v142")
    VGC_ENUM_VALUE(V143, "v143")
    VGC_ENUM_VALUE(V144, "v144")
    VGC_ENUM_VALUE(V145, "v145")
    VGC_ENUM_VALUE(V146, "v146")
    VGC_ENUM_VALUE(V147, "v147")
    VGC_ENUM_VALUE(V148, "v148")
    VGC_ENUM_VALUE(V149, "v149")
    VGC_ENUM_VALUE(V150, "v150")
    VGC_ENUM_VALUE(V151, "v151")
    VGC_ENUM_VALUE(V152, "v152")
    VGC_ENUM_VALUE(V153, "v153")
    VGC_ENUM_VALUE(V154, "v154")
    VGC_ENUM_VALUE(V155, "v155")
    VGC_ENUM_VALUE(V156, "v156")
    VGC_ENUM_VALUE(V157, "v157")
    VGC_ENUM_VALUE(V158, "v158")
    VGC_ENUM_VALUE(V159, "v159")
    VGC_ENUM_VALUE(V160, "v160")
    VGC_ENUM_VALUE(V161, "v161")
    VGC_ENUM_VALUE(V162, "v162")
    VGC_ENUM_VALUE(V163, "v163")
    VGC_ENUM_VALUE(V164, "v164")
    VGC_ENUM_VALUE(V165, "v165")
    VGC_ENUM_VALUE(V166, "v166")
    VGC_ENUM_VALUE(V167, "v167")
    VGC_ENUM_VALUE(V168, "v168")
    VGC_ENUM_VALUE(V169, "v169")
    VGC_ENUM_VALUE(V170, "v170")
    VGC_ENUM_VALUE(V171, "v171")
    VGC_ENUM_VALUE(V172, "v172")
    VGC_ENUM_VALUE(V173, "v173")
    VGC_ENUM_VALUE(V174, "v174")
    VGC_ENUM_VALUE(V175, "v175")
    VGC_ENUM_VALUE(V176, "v176")
    VGC_ENUM_VALUE(V177, "v177")
    VGC_ENUM_VALUE(V178, "v178")
    VGC_ENUM_VALUE(V179, "v179")
    VGC_ENUM_VALUE(V180, "v180")
    VGC_ENUM_VALUE(V181, "v181")
    VGC_ENUM_VALUE(V182, "v182")
    VGC_ENUM_VALUE(V183, "v183")
    VGC_ENUM_VALUE(V184, "v184")
    VGC_ENUM_VALUE(V185, "v185")
    VGC_ENUM_VALUE(V186, "v186")
    VGC_ENUM_VALUE(V187, "v187")
    VGC_ENUM_VALUE(V188, "v188")
    VGC_ENUM_VALUE(V189, "v189")
    VGC_ENUM_VALUE(V190, "v190")
    VGC_ENUM_VALUE(V191, "v191")
    VGC_ENUM_VALUE(V192, "v192")
    VGC_ENUM_VALUE(V193, "v193")
    VGC_ENUM_VALUE(V194, "v194")
    VGC_ENUM_VALUE(V195, "v195")
    VGC_ENUM_VALUE(V196, "v196")
    VGC_ENUM_VALUE(V197, "v197")
    VGC_ENUM_VALUE(V198, "v198")
    VGC_ENUM_VALUE(V199, "v199")
    VGC_ENUM_VALUE(V200, "v200")
VGC_DEFINE_ENUM_END()
