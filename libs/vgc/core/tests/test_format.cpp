...
VGC_DEFINE_ENUM_BEGIN((vgc, foo), VeryLongEnum)
    ...
    VGC_ENUMERATOR(V4, "v4")
    VGC_ENUMERATOR(V5, "v5")
    VGC_ENUMERATOR(V6, "v6")
    VGC_ENUMERATOR(V7, "v7")
    VGC_ENUMERATOR(V8, "v8")
    VGC_ENUMERATOR(V9, "v9")
    VGC_ENUMERATOR(V10, "v10")
    VGC_ENUMERATOR(V11, "v11")
    VGC_ENUMERATOR(V12, "v12")
    VGC_ENUMERATOR(V13, "v13")
    VGC_ENUMERATOR(V14, "v14")
    VGC_ENUMERATOR(V15, "v15")
    VGC_ENUMERATOR(V16, "v16")
    VGC_ENUMERATOR(V17, "v17")
    VGC_ENUMERATOR(V18, "v18")
    VGC_ENUMERATOR(V19, "v19")
    VGC_ENUMERATOR(V20, "v20")
    VGC_ENUMERATOR(V21, "v21")
    VGC_ENUMERATOR(V22, "v22")
    VGC_ENUMERATOR(V23, "v23")
    VGC_ENUMERATOR(V24, "v24")
    VGC_ENUMERATOR(V25, "v25")
    VGC_ENUMERATOR(V26, "v26")
    VGC_ENUMERATOR(V27, "v27")
    VGC_ENUMERATOR(V28, "v28")
    VGC_ENUMERATOR(V29, "v29")
    VGC_ENUMERATOR(V30, "v30")
    VGC_ENUMERATOR(V31, "v31")
    VGC_ENUMERATOR(V32, "v32")
    VGC_ENUMERATOR(V33, "v33")
    VGC_ENUMERATOR(V34, "v34")
    VGC_ENUMERATOR(V35, "v35")
    VGC_ENUMERATOR(V36, "v36")
    VGC_ENUMERATOR(V37, "v37")
    VGC_ENUMERATOR(V38, "v38")
    VGC_ENUMERATOR(V39, "v39")
    VGC_ENUMERATOR(V40, "v40")
    VGC_ENUMERATOR(V41, "v41")
    VGC_ENUMERATOR(V42, "v42")
    VGC_ENUMERATOR(V43, "v43")
    VGC_ENUMERATOR(V44, "v44")
    VGC_ENUMERATOR(V45, "v45")
    VGC_ENUMERATOR(V46, "v46")
    VGC_ENUMERATOR(V47, "v47")
    VGC_ENUMERATOR(V48, "v48")
    VGC_ENUMERATOR(V49, "v49")
    VGC_ENUMERATOR(V50, "v50")
    VGC_ENUMERATOR(V51, "v51")
    VGC_ENUMERATOR(V52, "v52")
    VGC_ENUMERATOR(V53, "v53")
    VGC_ENUMERATOR(V54, "v54")
    VGC_ENUMERATOR(V55, "v55")
    VGC_ENUMERATOR(V56, "v56")
    VGC_ENUMERATOR(V57, "v57")
    VGC_ENUMERATOR(V58, "v58")
    VGC_ENUMERATOR(V59, "v59")
    VGC_ENUMERATOR(V60, "v60")
    VGC_ENUMERATOR(V61, "v61")
    VGC_ENUMERATOR(V62, "v62")
    VGC_ENUMERATOR(V63, "v63")
    VGC_ENUMERATOR(V64, "v64")
    VGC_ENUMERATOR(V65, "v65")
    VGC_ENUMERATOR(V66, "v66")
    VGC_ENUMERATOR(V67, "v67")
    VGC_ENUMERATOR(V68, "v68")
    VGC_ENUMERATOR(V69, "v69")
    VGC_ENUMERATOR(V70, "v70")
    VGC_ENUMERATOR(V71, "v71")
    VGC_ENUMERATOR(V72, "v72")
    VGC_ENUMERATOR(V73, "v73")
    VGC_ENUMERATOR(V74, "v74")
    VGC_ENUMERATOR(V75, "v75")
    VGC_ENUMERATOR(V76, "v76")
    VGC_ENUMERATOR(V77, "v77")
    VGC_ENUMERATOR(V78, "v78")
    VGC_ENUMERATOR(V79, "v79")
    VGC_ENUMERATOR(V80, "v80")
    VGC_ENUMERATOR(V81, "v81")
    VGC_ENUMERATOR(V82, "v82")
    VGC_ENUMERATOR(V83, "v83")
    VGC_ENUMERATOR(V84, "v84")
    VGC_ENUMERATOR(V85, "v85")
    VGC_ENUMERATOR(V86, "v86")
    VGC_ENUMERATOR(V87, "v87")
    VGC_ENUMERATOR(V88, "v88")
    VGC_ENUMERATOR(V89, "v89")
    VGC_ENUMERATOR(V90, "v90")
    VGC_ENUMERATOR(V91, "v91")
    VGC_ENUMERATOR(V92, "v92")
    VGC_ENUMERATOR(V93, "v93")
    VGC_ENUMERATOR(V94, "v94")
    VGC_ENUMERATOR(V95, "v95")
    VGC_ENUMERATOR(V96, "v96")
    VGC_ENUMERATOR(V97, "v97")
    VGC_ENUMERATOR(V98, "v98")
    VGC_ENUMERATOR(V99, "v99")
    VGC_ENUMERATOR(V100, "v100")
    VGC_ENUMERATOR(V101, "v101")
    VGC_ENUMERATOR(V102, "v102")
    VGC_ENUMERATOR(V103, "v103")
    VGC_ENUMERATOR(V104, "v104")
    VGC_ENUMERATOR(V105, "v105")
    VGC_ENUMERATOR(V106, "v106")
    VGC_ENUMERATOR(V107, "v107")
    VGC_ENUMERATOR(V108, "v108")
    VGC_ENUMERATOR(V109, "v109")
    VGC_ENUMERATOR(V110, "v110")
    VGC_ENUMERATOR(V111, "v111")
    VGC_ENUMERATOR(V112, "v112")
    VGC_ENUMERATOR(V113, "v113")
    VGC_ENUMERATOR(V114, "v114")
    VGC_ENUMERATOR(V115, "v115")
    VGC_ENUMERATOR(V116, "v116")
    VGC_ENUMERATOR(V117, "v117")
    VGC_ENUMERATOR(V118, "v118")
    VGC_ENUMERATOR(V119, "v119")
    VGC_ENUMERATOR(V120, "v120")
    VGC_ENUMERATOR(V121, "v121")
    VGC_ENUMERATOR(V122, "v122")
    VGC_ENUMERATOR(V123, "v123")
    VGC_ENUMERATOR(V124, "v124")
    VGC_ENUMERATOR(V125, "v125")
    VGC_ENUMERATOR(V126, "v126")
    VGC_ENUMERATOR(V127, "v127")
    VGC_ENUMERATOR(V128, "v128")
    VGC_ENUMERATOR(V129, "v129")
    VGC_ENUMERATOR(V130, "v130")
    VGC_ENUMERATOR(V131, "v131")
    VGC_ENUMERATOR(V132, "v132")
    VGC_ENUMERATOR(V133, "v133")
    VGC_ENUMERATOR(V134, "v134")
    VGC_ENUMERATOR(V135, "v135")
    VGC_ENUMERATOR(V136, "v136")
    VGC_ENUMERATOR(V137, "v137")
    VGC_ENUMERATOR(V138, "v138")
    VGC_ENUMERATOR(V139, "v139")
    VGC_ENUMERATOR(V140, "v140")
    VGC_ENUMERATOR(V141, "v141")
    VGC_ENUMERATOR(V142, "v142")
    VGC_ENUMERATOR(V143, "v143")
    VGC_ENUMERATOR(V144, "v144")
    VGC_ENUMERATOR(V145, "v145")
    VGC_ENUMERATOR(V146, "v146")
    VGC_ENUMERATOR(V147, "v147")
    VGC_ENUMERATOR(V148, "v148")
    VGC_ENUMERATOR(V149, "v149")
    VGC_ENUMERATOR(V150, "v150")
    VGC_ENUMERATOR(V151, "v151")
    VGC_ENUMERATOR(V152, "v152")
    VGC_ENUMERATOR(V153, "v153")
    VGC_ENUMERATOR(V154, "v154")
    VGC_ENUMERATOR(V155, "v155")
    VGC_ENUMERATOR(V156, "v156")
    VGC_ENUMERATOR(V157, "v157")
    VGC_ENUMERATOR(V158, "v158")
    VGC_ENUMERATOR(V159, "v159")
    VGC_ENUMERATOR(V160, "v160")
    VGC_ENUMERATOR(V161, "v161")
    VGC_ENUMERATOR(V162, "v162")
    VGC_ENUMERATOR(V163, "v163")
    VGC_ENUMERATOR(V164, "v164")
    VGC_ENUMERATOR(V165, "v165")
    VGC_ENUMERATOR(V166, "v166")
    VGC_ENUMERATOR(V167, "v167")
    VGC_ENUMERATOR(V168, "v168")
    VGC_ENUMERATOR(V169, "v169")
    VGC_ENUMERATOR(V170, "v170")
    VGC_ENUMERATOR(V171, "v171")
    VGC_ENUMERATOR(V172, "v172")
    VGC_ENUMERATOR(V173, "v173")
    VGC_ENUMERATOR(V174, "v174")
    VGC_ENUMERATOR(V175, "v175")
    VGC_ENUMERATOR(V176, "v176")
    VGC_ENUMERATOR(V177, "v177")
    VGC_ENUMERATOR(V178, "v178")
    VGC_ENUMERATOR(V179, "v179")
    VGC_ENUMERATOR(V180, "v180")
    VGC_ENUMERATOR(V181, "v181")
    VGC_ENUMERATOR(V182, "v182")
    VGC_ENUMERATOR(V183, "v183")
    VGC_ENUMERATOR(V184, "v184")
    VGC_ENUMERATOR(V185, "v185")
    VGC_ENUMERATOR(V186, "v186")
    VGC_ENUMERATOR(V187, "v187")
    VGC_ENUMERATOR(V188, "v188")
    VGC_ENUMERATOR(V189, "v189")
    VGC_ENUMERATOR(V190, "v190")
    VGC_ENUMERATOR(V191, "v191")
    VGC_ENUMERATOR(V192, "v192")
    VGC_ENUMERATOR(V193, "v193")
    VGC_ENUMERATOR(V194, "v194")
    VGC_ENUMERATOR(V195, "v195")
    VGC_ENUMERATOR(V196, "v196")
    VGC_ENUMERATOR(V197, "v197")
    VGC_ENUMERATOR(V198, "v198")
