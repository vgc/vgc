...
//   pxr/base/lib/arch/defined.h
// and:
//   pxr/base/lib/arch/export.h
// from
...
// Modifications:
//  2017-11-07
//   merged dependent code from defines.h into export.h
//   renamed macros to comply with VGC naming scheme
//   updated documentation
//
// ----- End of Attributions -----

#ifndef VGC_CORE_EXPORT_H
#define VGC_CORE_EXPORT_H

/// \file vgc/core/export.h
///
/// Defines symbol visibility macros.
///
/// Defines \c VGC_CORE_EXPORT to indicate a symbol should be exported from
/// a library, \c VGC_CORE_IMPORT to indicate an exported symbol should be
/// imported (which only matters on Windows), and \c VGC_CORE_HIDDEN to
...
///  #       define FOO_API VGC_CORE_EXPORT
///  #       define FOO_API_TEMPLATE_CLASS(...) VGC_CORE_EXPORT_TEMPLATE(class, __VA_ARGS__)
///  #       define FOO_API_TEMPLATE_STRUCT(...) VGC_CORE_EXPORT_TEMPLATE(struct, __VA_ARGS__)
///  #   else
///  #       define FOO_API VGC_CORE_IMPORT
///  #       define FOO_API_TEMPLATE_CLASS(...) VGC_CORE_IMPORT_TEMPLATE(class, __VA_ARGS__)
///  #       define FOO_API_TEMPLATE_STRUCT(...) VGC_CORE_IMPORT_TEMPLATE(struct, __VA_ARGS__)
///  #   endif
///  #   define FOO_LOCAL VGC_CORE_HIDDEN
///  #endif
///
///  #endif
/// \endcode
///
/// This is used by all internal VGC libraries (e.g., FOO = VGC_GEOMETRY),
/// but can also be used by client of the VGC libraries.
///
...
#       define VGC_CORE_EXPORT __attribute__((dllexport))
#       define VGC_CORE_IMPORT __attribute__((dllimport))
#       define VGC_CORE_HIDDEN
#   else
#       define VGC_CORE_EXPORT __declspec(dllexport)
#       define VGC_CORE_IMPORT __declspec(dllimport)
#       define VGC_CORE_HIDDEN
#   endif
#elif defined(VGC_CORE_COMPILER_GCC) && VGC_CORE_COMPILER_GCC_MAJOR >= 4 || defined(VGC_CORE_COMPILER_CLANG)
#   define VGC_CORE_EXPORT __attribute__((visibility("default")))
#   define VGC_CORE_IMPORT
#   define VGC_CORE_HIDDEN __attribute__((visibility("hidden")))
#else
#   define VGC_CORE_EXPORT
#   define VGC_CORE_IMPORT
#   define VGC_CORE_HIDDEN
#endif
#define VGC_CORE_EXPORT_TEMPLATE(type, ...)
#define VGC_CORE_IMPORT_TEMPLATE(type, ...) extern template type VGC_CORE_IMPORT __VA_ARGS__

#endif // VGC_CORE_EXPORT_H
