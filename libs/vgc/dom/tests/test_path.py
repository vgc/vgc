...
class TestElement(unittest.TestCase):
    ...
    def testProps(self):
        ...
        # isRelativeToId
        self.assertFalse(Path("").beginsWithId)
        self.assertFalse(Path(".").beginsWithId)
        self.assertFalse(Path("aa/bb").beginsWithId)
        self.assertTrue(Path("#aa/bb").beginsWithId)
        self.assertFalse(Path("/aa/bb").beginsWithId)
        self.assertFalse(Path("/.cc").beginsWithId)
        # isElementPath
